...
_lr_productions = [
  ...
  ('program -> code','program',1,'p_program','Syntax.py',16),
  ('program -> <empty>','program',0,'p_program','Syntax.py',17),
  ('code -> code statement','code',2,'p_code','Syntax.py',21),
  ('code -> statement','code',1,'p_code','Syntax.py',22),
  ('statement -> declaration','statement',1,'p_statement','Syntax.py',29),
  ('statement -> assignment','statement',1,'p_statement','Syntax.py',30),
  ('statement -> prt','statement',1,'p_statement','Syntax.py',31),
  ('statement -> directives','statement',1,'p_statement','Syntax.py',32),
  ('statement -> ifst','statement',1,'p_statement','Syntax.py',33),
  ('directives -> NS DIRECTIVES LIBRARIES','directives',3,'p_directives','Syntax.py',37),
  ('declaration -> TYPE IDENTIFIER SEMIC','declaration',3,'p_declaration','Syntax.py',42),
  ('declaration -> TYPE IDENTIFIER EQUALS expression SEMIC','declaration',5,'p_declaration','Syntax.py',43),
  ('assignment -> IDENTIFIER EQUALS expression SEMIC','assignment',4,'p_assignment','Syntax.py',76),
  ('prt -> PRINT LPAREN expression RPAREN SEMIC','prt',5,'p_print','Syntax.py',99),
  ('ifst -> IF LPAREN valbool RPAREN OCURLB program CCURLB','ifst',7,'p_if','Syntax.py',105),
  ('ifst -> IF LPAREN valbool RPAREN OCURLB program CCURLB ELSE OCURLB program CCURLB','ifst',11,'p_if','Syntax.py',106),
  ('expression -> expression PLUS term','expression',3,'p_expression_plus','Syntax.py',112),
  ('expression -> expression MINUS term','expression',3,'p_expression_minus','Syntax.py',121),
  ('term -> term TIMES factor','term',3,'p_term_times','Syntax.py',131),
  ('term -> term DIVIDE factor','term',3,'p_term_div','Syntax.py',141),
  ('factor -> EXP LPAREN factor value RPAREN','factor',5,'p_factor_exp','Syntax.py',150),
  ('factor -> SQR LPAREN factor RPAREN','factor',4,'p_factor_sqr','Syntax.py',161),
  ('value -> NUMBER','value',1,'p_values_num','Syntax.py',172),
  ('valbool -> VAL_BOOL','valbool',1,'p_value_bool','Syntax.py',177),
  ('valbool -> LPAREN valbool RPAREN','valbool',3,'p_value_bool','Syntax.py',178),
  ('valbool -> expression OP_BOOL expression','valbool',3,'p_value_bool','Syntax.py',179),
  ('expression -> term','expression',1,'p_expression_term','Syntax.py',198),
  ('term -> factor','term',1,'p_term_factor','Syntax.py',203),
  ('factor -> value','factor',1,'p_factor_value','Syntax.py',208),
  ('factor -> IDENTIFIER','factor',1,'p_factor_value','Syntax.py',209),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor_value','Syntax.py',210),
  ('factor -> MINUS factor','factor',2,'p_factor_value','Syntax.py',211),
]
