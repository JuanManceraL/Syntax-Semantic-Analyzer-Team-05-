...
#    'IF', 'ELSE', 'PRINT', 'FLOAT', 'INT', 'BOOL', 'RETURN', 'PLUS', 'MINUS', 'TIMES', 'DIVIDE',
#    'LPARENT', 'RPARENT', ''
#]

tokens = [
    'KEYWORD', 'IDENTIFIER', 'PUNCTUATION', 'literals', 'CONSTANT', 'LITERAL', 'DIRECTIVE'
]
